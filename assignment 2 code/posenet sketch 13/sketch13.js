...
filter(THRESHOLD,1);    
    ...
    //added another ellipse, but for the left eye and changed the distance
    ellipse(pose.leftEye.x, pose.leftEye.y, d*1);

      //added another ellipse, but for the right ear and changed the colour
      stroke(125,0,0);
      ellipse(pose.rightEar.x, pose.rightEar.y, d*1);
